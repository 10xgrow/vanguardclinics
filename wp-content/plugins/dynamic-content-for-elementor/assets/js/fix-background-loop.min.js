dce = {
    applyDynamicStyles: function(element) {
        ...
        var colorAttrs = ["dce-text-color", "dce-title-color", "dce-background-color", "dce-background-hover-color", "dce-background-overlay-color", "dce-background-overlay-hover-color", "dce-advanced-background-color", "dce-advanced-background-hover-color", "dce-advanced-background-overlay-color", "dce-advanced-background-overlay-hover-color", ];
    ...
    addCssForBackgroundImage: function(element, value) {
        if (value) {
            var $target = this.getTargetElement(element, !0);

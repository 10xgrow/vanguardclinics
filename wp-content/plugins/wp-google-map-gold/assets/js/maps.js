    ...
    (function($, window, document, undefined) {
        ...
        GoogleMaps.prototype = {
            ...
            createMarker: function(place) {
                ...
                var marker_image = '';
                var image_url = typeof place.photos !== 'undefined' ? place.photos[0].getUrl({
                    maxWidth: 400,
                    maxHeight: 400
                }) : place.icon;
            ...
            create_markers: function() {
                ...
                if (map_obj.map_data.map_marker_spiderfier_setting !== undefined && map_obj.map_data.map_marker_spiderfier_setting.marker_spiderfy == 'true') {
                    ...
                    if (map_obj.map_data.map_marker_spiderfier_setting.marker_enable_spiral == 'true') {
                        oms_args = { ...oms_args,
                            ...{
                                circleSpiralSwitchover: map_obj.map_data.map_marker_spiderfier_setting.minimum_markers
                            }
                        };
                    }
